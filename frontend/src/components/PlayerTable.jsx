 ...
 * @param {{ players: Array<{ id: number; name: string; position: string; team: string | null }>, loading?: boolean }} props Props
 * @returns {JSX.Element}
 */
export default function PlayerTable({ players, loading }) {
